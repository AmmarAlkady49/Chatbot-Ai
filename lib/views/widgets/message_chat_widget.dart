...
import 'package:chatbot_ai/models/message_model.dart';
...
class _MessageChatWidgetState extends State<MessageChatWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final formatedDate = (DateTime.now().day ==
                DateTime.parse(widget.message.time).day &&
            DateTime.now().month == DateTime.parse(widget.message.time).month &&
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: widget.message.isUser == true
                    ? Colors.grey.shade800
                    : Colors.grey.shade900,
                borderRadius: BorderRadius.only(
                    topLeft: Radius.circular(25.r),
                    topRight: Radius.circular(25.r),
                    bottomLeft: widget.message.isUser == false
                        ? Radius.circular(3.r)
                        : Radius.circular(25.r),
                    bottomRight: widget.message.isUser == false
                        ? Radius.circular(25.r)
                        : Radius.circular(3.r)),
              ),
              child: widget.message.isUser == true
                          ...
                          animatedTexts: [
                            TypewriterAnimatedText(
                              ...
                              textStyle: FontHelper.fontText(
                                  16.sp, FontWeight.w500, Colors.white),
        ...
        Padding(
          ...
          child: Align(
            alignment: widget.message.isUser == false
                ? Alignment.bottomLeft
                : Alignment.bottomRight,
            child: Text(
              formatedDate,
              style: FontHelper.fontText(
                  12.sp, FontWeight.normal, Colors.grey.shade500),
            ),
          ),
        ),
      ],
