    ...
    return TextFormField(
      decoration: InputDecoration(
        enabledBorder: OutlineInputBorder(
          ...
          borderSide: chatBotCubit.selectedImage != null
        ...
        contentPadding: _controller.text.length <= 20
      ...
      style: FontHelper.fontText(16.sp, FontWeight.normal, Colors.white),
...
void showUploadMenu(
    BuildContext context, Offset position, Function(String) onSelect) {
  showMenu(
    context: context,
        ...
        child: Row(
          children: [
            ...
            Text(
              'Camera',
              style:
                  FontHelper.fontText(16.sp, FontWeight.normal, Colors.white),
            ),
          ],
        ),
      ),
